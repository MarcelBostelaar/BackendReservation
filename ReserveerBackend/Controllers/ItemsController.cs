...
namespace ReserveerBackend.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ItemName,Functional")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ItemName,Functional")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
